...
const StoreMenu = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      const props = ["--primary","--background","--foreground","--card","--secondary","--sidebar","--sidebar-accent","--primary-foreground","--border","--muted-foreground","--sidebar-foreground","--sidebar-border"];
